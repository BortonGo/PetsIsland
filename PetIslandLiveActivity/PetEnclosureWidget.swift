...
private enum WidgetSpriteAtlasLibrary {
    static func descriptor(
        ...
        case (.parrot, .classicParrot): .init(assetName: "widget_atlas_parrot_classic_fly", frameCount: 4)
        case (.parrot, .cockatiel): .init(assetName: "widget_atlas_parrot_cockatiel_fly", frameCount: 4)
        case (.parrot, .budgie): .init(assetName: "widget_atlas_parrot_budgie_fly", frameCount: 4)
